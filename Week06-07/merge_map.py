...
if __name__ == "__main__":
    ...
    parser.add_argument('--target-est', type=str, default='Week06-07/lab_output/targets.txt')
    ...
    for fruit in objects_est:
        ...
        for i in range(len(objects_est[fruit])):
            ...
            output[key]["x"] = objects_est[fruit][i][1]

    # print(output)
    json_object = json.dumps(output, indent=4)

    with open("Week08-09/m3_map.txt", "w") as outfile:
